  ...
  return (
    <Sheet open={isCartOpen} onOpenChange={setCartOpen}>
      <SheetContent className="flex flex-col w-full sm:max-w-md p-0">
        ...
        {/* Free shipping bar */}
        {cartCount > 0 && (
          <div className="mx-5 px-3 py-2 rounded-lg text-xs font-medium bg-secondary text-foreground">
        ...
        <div className="flex-1 overflow-y-auto px-5 py-3">
          {items.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-full text-center">
              ...
              <Button variant="outline" className="mt-4" onClick={() => { setCartOpen(false); navigate("/smartphones/alle"); }}>
                Jetzt einkaufen
              </Button>
            </div>
          ) : (
